...
namespace TinyFx.Demos.demo
{
	...
	public class Demo_courseMO : MySqlTableMO<Demo_courseEO>
	{
		...
		{
			RepairGetByPKData(year, courseID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
		...
		private void RepairGetByPKData(int year, string courseID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
		{
