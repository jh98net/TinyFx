...
namespace TinyFx.Demos.demo
{
	...
	public class Demo_user_courseMO : MySqlTableMO<Demo_user_courseEO>
	{
		...
		{
			RepairGetByPKData(userID, courseID, year, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
		...
		private void RepairGetByPKData(long userID, string courseID, int year, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false)
		{
