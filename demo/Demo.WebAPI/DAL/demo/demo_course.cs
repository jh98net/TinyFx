...
namespace Demo.WebAPI
{
	...
	public class Demo_courseMO : MySqlTableMO<Demo_courseEO>
	{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetYearByPK(int year, string courseID, TransactionManager tm_ = null)
		{
			...
			return GetScalar("`Year`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		public async Task<object> GetYearByPKAsync(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return await GetScalarAsync("`Year`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetCourseIDByPK(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return GetScalar("`CourseID`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		public async Task<object> GetCourseIDByPKAsync(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return await GetScalarAsync("`CourseID`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetNameByPK(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return GetScalar("`Name`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		public async Task<object> GetNameByPKAsync(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return await GetScalarAsync("`Name`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetOrderNumByPK(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return GetScalar("`OrderNum`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
		public async Task<object> GetOrderNumByPKAsync(int year, string courseID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Year", year, MySqlDbType.Year),
			...
			return await GetScalarAsync("`OrderNum`", "`Year` = @Year AND `CourseID` = @CourseID", paras_, tm_);
		}
