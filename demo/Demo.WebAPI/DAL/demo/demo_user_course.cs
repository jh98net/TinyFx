...
namespace Demo.WebAPI
{
	...
	public class Demo_user_courseMO : MySqlTableMO<Demo_user_courseEO>
	{
		...
		public override int Add(Demo_user_courseEO item, TransactionManager tm_ = null)
		{
			RepairAddData(item, out string sql_, out List<MySqlParameter> paras_);
			Database.ExecSqlNonQuery(sql_, paras_, tm_); 
	        return 1;
		}
		public override async Task<int> AddAsync(Demo_user_courseEO item, TransactionManager tm_ = null)
		{
			RepairAddData(item, out string sql_, out List<MySqlParameter> paras_);
			await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
	        return 1;
		}
	    private void RepairAddData(Demo_user_courseEO item, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = @"INSERT INTO `demo_user_course` (`UserID`, `Year`, `CourseID`, `Note`) VALUE (@UserID, @Year, @CourseID, @Note);";
		...
		{
			sql_ = @"DELETE FROM `demo_user_course` WHERE `UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"DELETE FROM `demo_user_course` WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user_course` WHERE `Year` = @Year";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user_course` WHERE `CourseID` = @CourseID";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user_course` WHERE " + (note != null ? "`Note` = @Note" : "`Note` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (note != null)
		...
		{
			sql_ = @"UPDATE `demo_user_course` SET `UserID` = @UserID, `Year` = @Year, `CourseID` = @CourseID, `Note` = @Note WHERE `UserID` = @UserID_Original AND `CourseID` = @CourseID_Original AND `Year` = @Year_Original";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", item.UserID, MySqlDbType.Int64),
				Database.CreateInParameter("@Year", item.Year, MySqlDbType.Year),
		...
		{
			sql_ = @"UPDATE `demo_user_course` SET `Note` = @Note  WHERE `UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			RepairGetByPKData(userID, courseID, year, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Demo_user_courseEO.MapDataReader);
		}
		public async Task<Demo_user_courseEO> GetByPKAsync(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			RepairGetByPKData(userID, courseID, year, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Demo_user_courseEO.MapDataReader);
		}
		private void RepairGetByPKData(long userID, string courseID, int year, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = BuildSelectSQL("`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", 0, null);
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
				Database.CreateInParameter("@CourseID", courseID, MySqlDbType.String),
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetUserIDByPK(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			...
			return GetScalar("`UserID`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		public async Task<object> GetUserIDByPKAsync(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return await GetScalarAsync("`UserID`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetYearByPK(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return GetScalar("`Year`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		public async Task<object> GetYearByPKAsync(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return await GetScalarAsync("`Year`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetCourseIDByPK(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return GetScalar("`CourseID`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		public async Task<object> GetCourseIDByPKAsync(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return await GetScalarAsync("`CourseID`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetNoteByPK(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return GetScalar("`Note`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
		public async Task<object> GetNoteByPKAsync(long userID, string courseID, int year, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			...
			return await GetScalarAsync("`Note`", "`UserID` = @UserID AND `CourseID` = @CourseID AND `Year` = @Year", paras_, tm_);
		}
