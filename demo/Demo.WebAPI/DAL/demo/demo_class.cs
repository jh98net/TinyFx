...
namespace Demo.WebAPI
{
	...
	public class Demo_classMO : MySqlTableMO<Demo_classEO>
	{
		...
		public override int Add(Demo_classEO item, TransactionManager tm_ = null)
		{
			RepairAddData(item, out string sql_, out List<MySqlParameter> paras_);
			Database.ExecSqlNonQuery(sql_, paras_, tm_); 
	        return 1;
		}
		public override async Task<int> AddAsync(Demo_classEO item, TransactionManager tm_ = null)
		{
			RepairAddData(item, out string sql_, out List<MySqlParameter> paras_);
			await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
	        return 1;
		}
	    private void RepairAddData(Demo_classEO item, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = @"INSERT INTO `demo_class` (`ClassID`, `Name`, `Sort1`, `Sort2`) VALUE (@ClassID, @Name, @Sort1, @Sort2);";
		...
		{
			sql_ = @"DELETE FROM `demo_class` WHERE `ClassID` = @ClassID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"DELETE FROM `demo_class` WHERE " + (name != null ? "`Name` = @Name" : "`Name` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (name != null)
		...
		{
			sql_ = @"DELETE FROM `demo_class` WHERE `Sort1` = @Sort1";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_class` WHERE `Sort2` = @Sort2";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_class` WHERE `Sort1` = @Sort1 AND `Sort2` = @Sort2";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_class` SET `ClassID` = @ClassID, `Name` = @Name, `Sort1` = @Sort1, `Sort2` = @Sort2 WHERE `ClassID` = @ClassID_Original";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", item.ClassID, MySqlDbType.VarChar),
				Database.CreateInParameter("@Name", item.Name != null ? item.Name : (object)DBNull.Value, MySqlDbType.VarChar),
		...
		{
			sql_ = @"UPDATE `demo_class` SET `Name` = @Name  WHERE `ClassID` = @ClassID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_class` SET `Sort1` = @Sort1  WHERE `ClassID` = @ClassID";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Sort1", sort1, MySqlDbType.Int32),
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
		...
		{
			sql_ = @"UPDATE `demo_class` SET `Sort2` = @Sort2  WHERE `ClassID` = @ClassID";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@Sort2", sort2, MySqlDbType.Int32),
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
		...
		{
			RepairGetByPKData(classID, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Demo_classEO.MapDataReader);
		}
		public async Task<Demo_classEO> GetByPKAsync(string classID, TransactionManager tm_ = null)
		{
			RepairGetByPKData(classID, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Demo_classEO.MapDataReader);
		}
		private void RepairGetByPKData(string classID, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = BuildSelectSQL("`ClassID` = @ClassID", 0, null);
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetNameByPK(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return GetScalar("`Name`", "`ClassID` = @ClassID", paras_, tm_);
		}
		public async Task<object> GetNameByPKAsync(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return await GetScalarAsync("`Name`", "`ClassID` = @ClassID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetSort1ByPK(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return GetScalar("`Sort1`", "`ClassID` = @ClassID", paras_, tm_);
		}
		public async Task<object> GetSort1ByPKAsync(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return await GetScalarAsync("`Sort1`", "`ClassID` = @ClassID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetSort2ByPK(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return GetScalar("`Sort2`", "`ClassID` = @ClassID", paras_, tm_);
		}
		public async Task<object> GetSort2ByPKAsync(string classID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@ClassID", classID, MySqlDbType.VarChar),
			};
			return await GetScalarAsync("`Sort2`", "`ClassID` = @ClassID", paras_, tm_);
		}
