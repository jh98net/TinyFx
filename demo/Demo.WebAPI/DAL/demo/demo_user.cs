...
namespace Demo.WebAPI
{
	...
	public class Demo_userMO : MySqlTableMO<Demo_userEO>
	{
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `ClassID` = @ClassID";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FBit` = @FBit";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBit_Max.HasValue ? "`FBit_Max` = @FBit_Max" : "`FBit_Max` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FTinyInt` = @FTinyInt";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fTinyInt_Unsigned.HasValue ? "`FTinyInt_Unsigned` = @FTinyInt_Unsigned" : "`FTinyInt_Unsigned` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBool.HasValue ? "`FBool` = @FBool" : "`FBool` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fBool.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `F_Boolean` = @F_Boolean";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBool_TinyInt.HasValue ? "`FBool_TinyInt` = @FBool_TinyInt" : "`FBool_TinyInt` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FSmallInt` = @FSmallInt";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fSmallInt_Unsigned.HasValue ? "`FSmallInt_Unsigned` = @FSmallInt_Unsigned" : "`FSmallInt_Unsigned` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FMediumInt` = @FMediumInt";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fMediumInt_Unsigned.HasValue ? "`FMediumInt_Unsigned` = @FMediumInt_Unsigned" : "`FMediumInt_Unsigned` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FInt` = @FInt";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fInt_Unsigned.HasValue ? "`FInt_Unsigned` = @FInt_Unsigned" : "`FInt_Unsigned` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Integer.HasValue ? "`F_Integer` = @F_Integer" : "`F_Integer` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FBigInt` = @FBigInt";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBigInt_Unsigned.HasValue ? "`FBigInt_Unsigned` = @FBigInt_Unsigned" : "`FBigInt_Unsigned` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FFloat` = @FFloat";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fFloat_Max.HasValue ? "`FFloat_Max` = @FFloat_Max" : "`FFloat_Max` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FDouble` = @FDouble";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fDouble_Max.HasValue ? "`FDouble_Max` = @FDouble_Max" : "`FDouble_Max` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Real.HasValue ? "`F_Real` = @F_Real" : "`F_Real` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (f_Real.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Double_Precision.HasValue ? "`F_Double_Precision` = @F_Double_Precision" : "`F_Double_Precision` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fYear.HasValue ? "`FYear` = @FYear" : "`FYear` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fYear.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fDate.HasValue ? "`FDate` = @FDate" : "`FDate` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fDate.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fTime.HasValue ? "`FTime` = @FTime" : "`FTime` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fTime.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fTimestamp.HasValue ? "`FTimestamp` = @FTimestamp" : "`FTimestamp` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fDateTime.HasValue ? "`FDateTime` = @FDateTime" : "`FDateTime` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fChar != null ? "`FChar` = @FChar" : "`FChar` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fChar != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fVarChar != null ? "`FVarChar` = @FVarChar" : "`FVarChar` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fVarChar != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBinary != null ? "`FBinary` = @FBinary" : "`FBinary` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fBinary != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fVarBinary != null ? "`FVarBinary` = @FVarBinary" : "`FVarBinary` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fVarBinary != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fTinyText != null ? "`FTinyText` = @FTinyText" : "`FTinyText` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fTinyText != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fText != null ? "`FText` = @FText" : "`FText` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fText != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fMediumText != null ? "`FMediumText` = @FMediumText" : "`FMediumText` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fMediumText != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fLongText != null ? "`FLongText` = @FLongText" : "`FLongText` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fLongText != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fTinyBlob != null ? "`FTinyBlob` = @FTinyBlob" : "`FTinyBlob` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fTinyBlob != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fBlob != null ? "`FBlob` = @FBlob" : "`FBlob` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fBlob != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fMediumBlob != null ? "`FMediumBlob` = @FMediumBlob" : "`FMediumBlob` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fMediumBlob != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fLongBlob != null ? "`FLongBlob` = @FLongBlob" : "`FLongBlob` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fLongBlob != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fEnum != null ? "`FEnum` = @FEnum" : "`FEnum` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fEnum != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fSet != null ? "`FSet` = @FSet" : "`FSet` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (fSet != null)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE `FDecimal` = @FDecimal";
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (fDecimal_Max.HasValue ? "`FDecimal_Max` = @FDecimal_Max" : "`FDecimal_Max` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Numeric.HasValue ? "`F_Numeric` = @F_Numeric" : "`F_Numeric` IS NULL");
			paras_ = new List<MySqlParameter>();
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Dec.HasValue ? "`F_Dec` = @F_Dec" : "`F_Dec` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (f_Dec.HasValue)
		...
		{
			sql_ = @"DELETE FROM `demo_user` WHERE " + (f_Fixed.HasValue ? "`F_Fixed` = @F_Fixed" : "`F_Fixed` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (f_Fixed.HasValue)
		...
		{
			sql_ = @"UPDATE `demo_user` SET `ClassID` = @ClassID  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBit` = @FBit  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBit_Max` = @FBit_Max  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTinyInt` = @FTinyInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTinyInt_Unsigned` = @FTinyInt_Unsigned  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBool` = @FBool  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Boolean` = @F_Boolean  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBool_TinyInt` = @FBool_TinyInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FSmallInt` = @FSmallInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FSmallInt_Unsigned` = @FSmallInt_Unsigned  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FMediumInt` = @FMediumInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FMediumInt_Unsigned` = @FMediumInt_Unsigned  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FInt` = @FInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FInt_Unsigned` = @FInt_Unsigned  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Integer` = @F_Integer  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBigInt` = @FBigInt  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBigInt_Unsigned` = @FBigInt_Unsigned  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FFloat` = @FFloat  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FFloat_Max` = @FFloat_Max  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDouble` = @FDouble  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDouble_Max` = @FDouble_Max  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Real` = @F_Real  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Double_Precision` = @F_Double_Precision  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FYear` = @FYear  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDate` = @FDate  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTime` = @FTime  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTimestamp` = @FTimestamp  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDateTime` = @FDateTime  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FChar` = @FChar  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FVarChar` = @FVarChar  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBinary` = @FBinary  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FVarBinary` = @FVarBinary  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTinyText` = @FTinyText  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FText` = @FText  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FMediumText` = @FMediumText  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FLongText` = @FLongText  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FTinyBlob` = @FTinyBlob  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FBlob` = @FBlob  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FMediumBlob` = @FMediumBlob  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FLongBlob` = @FLongBlob  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FEnum` = @FEnum  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FSet` = @FSet  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDecimal` = @FDecimal  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `FDecimal_Max` = @FDecimal_Max  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Numeric` = @F_Numeric  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Dec` = @F_Dec  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		{
			sql_ = @"UPDATE `demo_user` SET `F_Fixed` = @F_Fixed  WHERE `UserID` = @UserID";
			paras_ = new List<MySqlParameter>() 
			{
		...
		public async Task<Demo_userEO> GetByPKAsync(long userID, TransactionManager tm_ = null)
		{
			RepairGetByPKData(userID, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Demo_userEO.MapDataReader);
		}
		private void RepairGetByPKData(long userID, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetClassIDByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`ClassID`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetClassIDByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`ClassID`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBitByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBit`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBitByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBit`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBit_MaxByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBit_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBit_MaxByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBit_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTinyIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTinyInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTinyIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTinyInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTinyInt_UnsignedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTinyInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTinyInt_UnsignedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTinyInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBoolByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBool`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBoolByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBool`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_BooleanByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Boolean`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_BooleanByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Boolean`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBool_TinyIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBool_TinyInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBool_TinyIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBool_TinyInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFSmallIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FSmallInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFSmallIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FSmallInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFSmallInt_UnsignedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FSmallInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFSmallInt_UnsignedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FSmallInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFMediumIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FMediumInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFMediumIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FMediumInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFMediumInt_UnsignedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FMediumInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFMediumInt_UnsignedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FMediumInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFInt_UnsignedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFInt_UnsignedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_IntegerByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Integer`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_IntegerByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Integer`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBigIntByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBigInt`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBigIntByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBigInt`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBigInt_UnsignedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBigInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBigInt_UnsignedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBigInt_Unsigned`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFFloatByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FFloat`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFFloatByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FFloat`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFFloat_MaxByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FFloat_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFFloat_MaxByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FFloat_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDoubleByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDouble`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDoubleByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDouble`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDouble_MaxByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDouble_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDouble_MaxByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDouble_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_RealByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Real`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_RealByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Real`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_Double_PrecisionByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Double_Precision`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_Double_PrecisionByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Double_Precision`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFYearByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FYear`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFYearByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FYear`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDateByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDate`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDateByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDate`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTimeByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTime`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTimeByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTime`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTimestampByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTimestamp`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTimestampByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTimestamp`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDateTimeByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDateTime`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDateTimeByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDateTime`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFCharByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FChar`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFCharByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FChar`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFVarCharByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FVarChar`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFVarCharByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FVarChar`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBinaryByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBinary`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBinaryByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBinary`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFVarBinaryByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FVarBinary`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFVarBinaryByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FVarBinary`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTinyTextByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTinyText`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTinyTextByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTinyText`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTextByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FText`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTextByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FText`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFMediumTextByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FMediumText`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFMediumTextByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FMediumText`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFLongTextByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FLongText`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFLongTextByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FLongText`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFTinyBlobByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FTinyBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFTinyBlobByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FTinyBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFBlobByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFBlobByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFMediumBlobByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FMediumBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFMediumBlobByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FMediumBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFLongBlobByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FLongBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFLongBlobByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FLongBlob`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFEnumByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FEnum`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFEnumByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FEnum`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFSetByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FSet`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFSetByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FSet`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDecimalByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDecimal`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDecimalByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDecimal`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetFDecimal_MaxByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`FDecimal_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetFDecimal_MaxByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`FDecimal_Max`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_NumericByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Numeric`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_NumericByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Numeric`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_DecByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Dec`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_DecByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Dec`", "`UserID` = @UserID", paras_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public object GetF_FixedByPK(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return GetScalar("`F_Fixed`", "`UserID` = @UserID", paras_, tm_);
		}
		public async Task<object> GetF_FixedByPKAsync(long userID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserID", userID, MySqlDbType.Int64),
			};
			return await GetScalarAsync("`F_Fixed`", "`UserID` = @UserID", paras_, tm_);
		}
