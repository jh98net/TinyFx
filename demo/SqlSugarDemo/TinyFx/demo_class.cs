...
namespace SqlSugarDemo.DAL
{
	...
	public class Demo_classMO : MySqlTableMO<Demo_classEO>
	{
		...
		{
			RepairGetByPKData(classID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
		...
		private void RepairGetByPKData(string classID, out string sql_, out List<MySqlParameter> paras_, bool isForUpdate_ = false, TransactionManager tm_ = null)
		{
