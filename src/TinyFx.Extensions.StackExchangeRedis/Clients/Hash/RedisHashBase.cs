...
namespace TinyFx.Extensions.StackExchangeRedis
{
    public class RedisHashBase<TField> : RedisClientBase
    {
        ...
        public RedisHashBase(object key = null, RedisClientOptions options = null) : base(key, options) { }
        ...
        private CacheValue<TField> GetCacheValue(RedisValue value)
        {
            return TryDeserialize(value, out TField v)
