...
namespace TinyFx.Extensions.StackExchangeRedis.Serializers
{
    ...
    /// </summary>
    public class RedisBytesSerializer : SerializerBase
    {
        public override byte[] Serialize(object value)
        {
            ...
            var json = Encoding.UTF8.GetBytes(SerializerUtil.SerializeJsonNet(value));
            return json;
        }
        ...
        public override object Deserialize(byte[] utf8Bytes, Type returnType)
        {
            ...
            var ret = SerializerUtil.DeserializeJsonNet(Encoding.UTF8.GetString(utf8Bytes), returnType);
            return ret;
        }
    }
}
